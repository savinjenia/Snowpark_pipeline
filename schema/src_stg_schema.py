from snowflake.snowpark.types import StringType, StructField, StructType, DateType,LongType,DoubleType
...
int_emp_details_avro = StructType([StructField('REGISTRATION_DTTM', StringType(), nullable=False), 
                                   ...
                                   StructField('CC', LongType(), nullable=True), 
